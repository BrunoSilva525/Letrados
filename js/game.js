let palavras = ["banana", "laranja", "maçã", "abacaxi", "uva", "morango", "jaca", "tomate", "nicaragua", "samambaia"];
let palavraSecreta = palavras[Math.floor(Math.random() * palavras.length)]; // Escolhe uma palavra aleatória
